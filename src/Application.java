...
public class Application {
    ...
    public Solution getSolution(List<Client> voisinage, Vehicule vehicule, Depot depot, List<Client> clients, int nbIteration, TrouverVoisinType typeVoisin) {
    ...
    public Map<Integer, List<Point>> capaciteHeuristique(List<Client> clients, Vehicule vehicule, Depot depot) {
    ...
    public List<List<Client>> trouverVoisin1(List<Client> clients) {
    ...
    public List<List<Client>> trouverVoisin2(List<Client> clients) {
        // On cherche à créer une liste de liste de clients
        List<List<Client>> result = new ArrayList();
    ...
    public List<List<Client>> trouverVoisin3(List<Client> clients) {
        // On cherche à créer une liste de liste de clients
        List<List<Client>> result = new ArrayList();
